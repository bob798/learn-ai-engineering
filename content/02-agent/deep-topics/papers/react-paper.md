...
> 详细的 6 条历史血脉见 [Agent Loop 深度理解](../../concepts/02-agent-loop.md#-远古思想源loop-的六条血脉)。
...
| 理解 Loop 的理论深度 | [Agent Loop 深度理解](../../concepts/02-agent-loop.md)（60 年血脉、messages 数组机制） |
...
| 了解 ReAct 之后的 Agent 生态演化 | [Agent 生态 2026](../../research/agent-ecosystem-2026.md) |
